  ...
  return (
    <div className="min-h-screen bg-surface font-body">
      ...
      <main className="app-reading-container py-8 prose dark:prose-invert text-on-surface-variant">
        ...
        <h2>3. 账号与第三方登录</h2>
        <p>您可以使用邮箱密码登录，也可以在完成验证后将微信绑定为同一账号的登录方式。微信绑定不会创建数据副本，也不会自动合并两个已有账号。若微信已绑定其他账号，系统会拒绝再次绑定，以保护各账号中的私密日记。</p>
        <p>绑定或解除微信前需要验证当前账号邮箱。解除绑定后，邮箱账号、密码和已有数据继续保留；您应妥善保管邮箱、密码和微信账号。</p>
